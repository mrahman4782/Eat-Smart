...
import { Box, TextField, Button, Grid, Typography, MenuItem, FormControl, Select, InputLabel } from '@mui/material';
...
const Register = () => {
    ...
    const registerButtonPress = async (event) => {
            ...
            <Grid container alignItems="center" justifyContent="center" style={{ height: '100%', margin: 0 }}>
                ...
                {!submitClicked ? 
                    <Grid item xs={12} sm={6} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#F9F6F0', margin: 0, height: '100vh'}}>
                        ...
                        <Button color="secondary" onClick={navigateToLogin} sx={{ marginTop: 1 }}>Already have an account? Login here</Button>
